    ...
    def as_dict(self, extra_fields=False):
        if extra_fields:
            return {
                ...
                "restaurants": [r.as_dict() for r in self.restaurants.all()],
...
class Restaurant(models.Model):
    ...
    def as_dict(self):
        return {
            ...
            "popularity_rate": float(self.popularity_rate)
            if self.popularity_rate
            else None,
            "satisfaction_rate": float(self.satisfaction_rate)
            if self.satisfaction_rate
            else None,
